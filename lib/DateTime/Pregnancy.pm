...
DateTime::Pregnancy - calculate birthdate and week numbers for a pregnancy

=head1 SYNOPSIS

	use DateTime::Pregnancy qw(calculate_birthday);
	...
	use DateTime::Pregnancy qw(calculate_week);
	...
	use DateTime::Pregnancy qw(calculate_month);
...
Please report issues via CPAN RT:
  ...
  http://rt.cpan.org/NoAuth/Bugs.html?Dist=DateTime-Pregnancy

or by sending mail to

  bug-DateTime-Pregnancy@rt.cpan.org
...
excuse L<DateTime::Pregnancy> is a reality.
...
DateTime-Pregnancy is (C) by Jonas B. Nielsen, (jonasbn) 2004

DateTime-Pregnancy is released under the artistic license
